...
\begin{figure}[p]
	...
	\renewcommand{\legendstyle}{at={(0.01,1)},anchor=north west}
	\renewcommand{\legendcols}{2}
	\quantileplot{evt-quantile.csv}%
	{storm.sparse.luexact.ignored,
	storm.sparse.luexact-topo.ignored,
	storm.sparse.lu.0.001,
	storm.sparse.lu-topo.0.001,
	storm.sparse.gmres.1e-06,
	storm.sparse.gmres-topo.1e-06,
	storm.sparse.vi.1e-06,
	storm.sparse.vi-topo.1e-06,
	storm.sparse.ii.0.001,
	storm.sparse.ii-topo.0.001,
	storm.sparse.ovi.0.001,
	storm.sparse.ovi-topo.0.001}%
	{{\method{LU$^X$}},
	{\method{LU$^X$/topo}},
	{\method{LU}}, 
	{\method{LU/topo}},
	...
	\scatterplotevtcat{evt-scatter.csv}
	{storm.sparse.gmres.0.001}{{\method{gmres}}}
	{storm.sparse.ovi.0.001}{{\method{OVI}}}
	{false}%
	\scatterplotevtcat{evt-scatter.csv}
	{storm.sparse.ii.0.001}{{\method{II}}}
	{storm.sparse.ovi.0.001}{{\method{OVI}}}
	{true}%
	\scatterplotevtcat{evt-scatter.csv}
	{storm.sparse.ovi-topo.0.001}{{\method{OVI/topo}}}
	{storm.sparse.ovi.0.001}{{\method{OVI}}}
	{false}%
	\caption{Runtime comparison for EVTs}
	\label{fig:runtime_evt}
\end{figure}
\begin{figure}[p]
			\renewcommand{\legendstyle}{at={(0.45,1.05)},anchor=south}
			\setlength{\numberruntimeplotwidth}{\linewidth}
			\renewcommand{\legendcols}{-1}
			\numberruntimeplot{evt-scatter.csv}%
				{storm.sparse.luexact-topo.ignored,
				storm.sparse.lu-topo.0.001,
				storm.sparse.gmres-topo.1e-06,
				storm.sparse.ii-topo.0.001,
			...
			\caption{Runtime of the EVT approaches for different state space sizes $|S|$.}
			\label{fig:statestime_evt}
\end{figure}
...
\begin{figure}[p]
  \centering
    ...
    \renewcommand{\legendcols}{-1}
	\renewcommand{\legendstyle}{at={(0.45,1.05)},anchor=south}
		{\precisionplot{evt-reldiff.csv}%
		{storm.sparse.gmres.0.001, storm.sparse.vi.0.001, storm.sparse.ii.0.001, storm.sparse.ovi.0.001}%
        {{\method{gmres}},
		{\method{VI}},
	    {\method{II}},
    	{\method{OVI}}}
		...
		{\precisionplot{evt-reldiff.csv}%
		{storm.sparse.gmres-topo.0.001, storm.sparse.vi-topo.0.001, storm.sparse.ii-topo.0.001, storm.sparse.ovi-topo.0.001}%
        {{\method{gmres/topo}},
		{\method{VI/topo}},
	    {\method{II/topo}},
    	{\method{OVI/topo}}}
		...
		{$\diff{rel}$}{states}{$\varepsilon=10^{-3}$}}\\
		{\precisionplot{evt-reldiff.csv}%
		{storm.sparse.gmres.1e-06, storm.sparse.vi.1e-06, storm.sparse.ii.1e-06, storm.sparse.ovi.1e-06}%
        {{\method{gmres}},
		{\method{VI}},
	    {\method{II}},
    	{\method{OVI}}}
		...
		{\precisionplot{evt-reldiff.csv}%
		{storm.sparse.gmres-topo.1e-06, storm.sparse.vi-topo.1e-06, storm.sparse.ii-topo.1e-06, storm.sparse.ovi-topo.1e-06}%
        {{\method{gmres/topo}},
		{\method{VI/topo}},
	    {\method{II/topo}},
    	{\method{OVI/topo}}}
		...
		{$\diff{rel}$}{states}{$\varepsilon=10^{-6}$}}	%}
   \caption%
 {Relative difference between obtained results and true EVTs.}
\label{fig:evtprecision}
\end{figure}
