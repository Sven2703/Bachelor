...
\begin{figure}[hp]
	...
	\renewcommand{\numberruntimeplotxmode}{normal}
	\renewcommand{\numberruntimeplotxmin}{3}
	\renewcommand{\legendstyle}{at={(0.45,1.05)},anchor=south}
	{\numberruntimeplot{philosophers-dl.csv}%
	{
	...
	{\method{OVI}}}%
	{$N$}
	{time in seconds}{Parameters}{20}%64000 = max N
	}\\
	{\numberruntimeplot{philosophers-dlfix.csv}%
	{
	greatspn.default.ggsc.0.001,
...
\caption{Runtime for computing EVTs (top) and stationary distributions (bottom) for the dining philosophers.}\label{fig:runtime_dining}
\end{figure}
