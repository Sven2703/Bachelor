...
date
python3 ../scripts/run.py -t evts -r results_dl -f inv_dl.json

echo "Start benchmarking variant without deadlock"
date
python3 ../scripts/run.py -t stationary -r results_dlfix -f inv_dlfix.json

echo "Starting postprocessing of results "
python3 ../scripts/postprocess.py -t evts -r results_dl -l 1800
python3 ../scripts/postprocess.py -t stationary -r results_dlfix -l 1800
