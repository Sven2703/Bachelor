...
\begin{figure}[hp]
	...
	{\method{EVTfull/OVI}}}
	{$N$}
	{time in seconds}{Parameters}{300000}%64000 = max N
	}
	\caption{Verification times for Lumbroso's Fast Dice Roller.}\label{fig:runtime_lumbroso}
\end{figure}
